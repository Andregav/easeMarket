(function() {
    ...
    function scrollFunction() {
        if (document.body.scrollTop > 80 || document.documentElement.scrollTop > 80) {
            ...
            document.querySelector(".navbar").style.background = "#84aa56";
            ...
            document.querySelector(".navbar").style.padding = "0px 10px";
            document.querySelector(".navbar").style.margin = "78px 0 0 0";
            document.getElementById("logo").style.fontSize = "35px";
            document.querySelector(".navbar").style.background = "rgba(0, 0, 0, 0)";
            document.querySelector(".navbar").style.left = "auto";
